          ...
          <div className="glass-card p-6 space-y-5">
            <div className="flex items-center gap-3 mb-1">
              ...
              {user?.rol === "admin" ? (
                ...
                <span className="ml-auto text-[10px] bg-blue-400/20 text-blue-300 px-2 py-1 rounded-full font-bold flex items-center gap-1">
                  <FiShield className="w-3 h-3" />
                  PERIODISTA
                </span>
              ) : isSubscribed && (
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card p-6 space-y-4">
            ...
            {subLoading ? (
              ...
              <div className="text-center py-4">
                <div className="inline-flex items-center gap-2 bg-blue-400/10 text-blue-300 text-xs font-bold px-3 py-1.5 rounded-full mb-3">
                  <FiShield className="w-3.5 h-3.5" />
                  PERIODISTA
                </div>
                <p className="text-sm text-gray-300 mb-1">Acceso completo ilimitado</p>
                <p className="text-xs text-gray-400">
                  Tu cuenta de periodista tiene acceso premium automático a todas las funciones de la plataforma.
                </p>
              </div>
            ) : (
              <>
